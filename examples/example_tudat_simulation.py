## Example TUDAT orbit simulation, returning three LEO and 1 MEO orbit
...
# Formula modified: also make it for current time instead.

# J2000 time
t_j2000_now = t_conv.gps_to_j2000(t_conv.utc2gws(dt.datetime.now()))
simulation_start_epoch = t_j2000_now+ sim_start #  x 365.25 days/yr * 24 hrs/day * 3600 sec/hr [seconds since J2000]
# GPS time
# t_now = dt.datetime.now()
# simulation_start_epoch = utc2gws(t_now)+ sim_start # 
...
ic_sats = np.array(
    ...
    [7378e3, 0.0001, np.deg2rad(89), np.deg2rad(0.1), 0, np.deg2rad(15.65)], # ~2000 km link distance, but also leads to 23 sats/plane
