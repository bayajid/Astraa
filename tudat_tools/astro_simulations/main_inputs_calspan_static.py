...
# SINGLE DAY
# Innsbruck; 97km south from munich
target_coord = [47.2675, 11.391, 574] # lat long h
...
output_folder = r'outputs/tables/calspan'
...
if output_day_tabular_data: # MOON-ANGLE CSV GENERATION FOR SCANS AND TRACKING AND WHATNOT
    ...
    full_output_folder = f'{output_folder}//{t_start_local.date().isoformat()}'
    zip_name = f'{t_start_local.date().isoformat()}.zip'
    try:            
