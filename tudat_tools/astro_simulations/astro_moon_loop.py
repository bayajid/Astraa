...
day_start = 15
day_end = 28 
day_lst = np.arange(day_start, day_end+1, 1).astype(int)
month_used = 2
...
if output_full_tabular_data: # MOON-ANGLE CSV GENERATION FOR SCANS AND TRACKING AND WHATNOT
    for day_used in day_lst:
        # body = 'moon'
        # pt_direction = 'NWU' # North, West, Up terminal pointing
...
if output_long_window_data:
    ...
    loop_length = int(60 / dt_mins* (h_end-h_start + (nr_days-1.5)*24))
